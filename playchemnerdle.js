this.nerdle = this.nerdle || {}, this.nerdle.bundle = function(e) {
    ...
    var va = ["limit", "prion", "sugar", "solid", "nisil", "drift", "salts", "cures", "ester", "terne", "genes", "freon", "ylide", "ether", "ideal", "radon", "vinyl", "waves", "lipid", "enols", "basal", "bases", "imide", "pulse", "wootz", "kovar", "oxime", "volts", "epoxy", "units", "toxic", "Gibbs", "amine", "redox", "anils", "phase", "argon", "curie", "cages", "laser", "shear", "borax", "furan", "inert", "iodic", "imino", "farad", "tests", "group", "batch", "imene", "doses", "fluid", "azoth", "aryne", "quark", "latex", "ethyl", "anion", "bonds", "oligo", "bronz", "steel", "triad", "pipet", "anode", "graft", "azane", "yocto", "alkyl", "Bunte", "bulat", "agent", "amide", "boson", "codon", "Tjump", "diols", "boron", "ionic", "acids", "orcin", "flask", "probe", "renin", "beryl", "Boyle", "areic", "silyl", "ratio", "actin", "moles", "neper", "atoms", "alloy", "power", "watts", "malic", "acute", "cells", "octet", "shift", "drugs", "diazo", "noble", "metal", "azoxy", "films", "oxide", "layer", "Auger", "chain", "gases", "katal", "fumes", "water", "assay", "joule", "ricin", "donor", "azine", "basis", "block", "pitch", "exons", "value", "state", "ynols", "xrays", "acene", "arene", "brass", "dimer", "tesla", "azete", "ducol", "titin", "axial", "shell", "xenic", "azene", "crown", "rates", "helix", "level", "thiol", "resin", "aryls", "xenon", "amino", "imine", "auxin", "dynes", "serum", "educt", "lumen", "elute", "torrs", "blend", "fermi", "cecyl", "clone", "decay", "boric", "yield", "octyl", "spiro", "Bragg", "debye", "azide", "molar", "Lewis", "amyls", "hertz", "invar", "threo", "yotta", "toxin"];
    ...
    var qa = new Date(2021, 1, 6, 0, 0, 0, 0);
    ...
    var Pa = "IN_PROGRESS",
        ...
        Fa = "FAIL",
        Ba = [
            ["Outstanding!!", "Woah, you are an ace chemist!"],
            ["Fantastic!", "Wonderful!"],
